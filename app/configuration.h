...
class configuration {
        public:
                ...
                void strongmap( PartitionConfig & partition_config );
                void ecomap( PartitionConfig & partition_config );
                void fastmap( PartitionConfig & partition_config );
                void fastestmap( PartitionConfig & partition_config );

                void ssocialmap( PartitionConfig & partition_config );
                void esocialmap( PartitionConfig & partition_config );
                void fsocialmap( PartitionConfig & partition_config );
                void ffsocialmap( PartitionConfig & partition_config );
...
inline void configuration::strongmap( PartitionConfig & partition_config ) {
...
inline void configuration::ssocialmap( PartitionConfig & partition_config ) {
...
inline void configuration::ecomap( PartitionConfig & partition_config ) {
		fast(partition_config);
                partition_config.fm_search_limit                        = 0;
                // partition_config.kway_fm_search_limit                   = 0; 
                partition_config.corner_refinement_enabled              = false; 
...
inline void configuration::esocialmap( PartitionConfig & partition_config ) {
		fastsocial(partition_config);
		partition_config.matching_type				= CLUSTER_COARSENING;
                partition_config.adapt_bal				= true;
                partition_config.fm_search_limit                        = 0;
...
inline void configuration::fastmap( PartitionConfig & partition_config ) {
		fast(partition_config);
                partition_config.fm_search_limit                        = 0;
                // partition_config.kway_fm_search_limit                   = 0; 
                partition_config.corner_refinement_enabled              = false; 
...
inline void configuration::fastestmap( PartitionConfig & partition_config ) {
		fast(partition_config);
                partition_config.fm_search_limit                        = 0;
                // partition_config.kway_fm_search_limit                   = 0; 
                partition_config.corner_refinement_enabled              = false; 
...
inline void configuration::ffsocialmap( PartitionConfig & partition_config ) {
		fastsocial(partition_config);
		partition_config.matching_type				= CLUSTER_COARSENING;
                partition_config.adapt_bal				= true;
                partition_config.fm_search_limit                        = 0;
