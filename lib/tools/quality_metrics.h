...
double Consistency(graph_access & G, complete_boundary & boundary);
        ...
        NodeWeight total_qap_noquotient(graph_access & G, int * partition_map, matrix & D, std::vector< NodeID > & rank_assign);
        NodeWeight total_qap_noquotient(graph_access & G, matrix & D, std::vector< NodeID > & rank_assign);
